...
const BranchProfile: React.FC<UserProfileProps> = () => {
  ...
  const userData: UserData | null = branchData
    ? {
        ...
        joinDate: branchData.createdAt.toString(),
      }
    : null;
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Branch</p>
                  </div>
                </li>
              </ul>
            </div>
