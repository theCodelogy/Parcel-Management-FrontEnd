...
const CreateParcelPageMerchant: React.FC = () => {
  ...
  useEffect(() => {
    if (deliveryChargesData?.data) {
      setDeliveryChargeData(deliveryChargesData.data as DeliveryChargeData[]);
    }
...
export default CreateParcelPageMerchant;
