...
const EditParcelPage: React.FC = () => {
  ...
  useEffect(() => {
    axios
      .get("https://parcel-management-back-end.vercel.app/api/v1/deliveryCategory")
      .then((response) => {
  ...
  useEffect(() => {
    axios
      .get("https://parcel-management-back-end.vercel.app/api/v1/deliveryCharge")
      .then((response) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    axios
      .post("https://parcel-management-back-end.vercel.app/api/v1/parcel", payload)
      .then((response) => {
    ...
    <div className="p-6 bg-white rounded-lg shadow-md max-w-7xl mx-auto">
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex-1">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">Edit Parcel</h2>
