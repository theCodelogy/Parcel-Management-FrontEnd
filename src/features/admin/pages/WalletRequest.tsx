      ...
      <div className="p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="flex space-x-4 border-b overflow-x-auto">
          {["All Transactions", "Recharges"].map((tab) => (
            <button
              key={tab}
              className={`py-2 px-4 text-lg font-medium border-b-2 transition-all whitespace-nowrap ${
                activeTab === tab
        ...
        <div className="overflow-x-auto mt-4">
          {activeTab === "All Transactions" ? (
            ...
            <table className="w-full border-collapse border">
              <thead className="bg-gray-200">
                <tr>
                  {["#", "Merchant", "Date", "Amount", "Status", "Actions"].map(
                    (header) => (
                      <th key={header} className="p-2 border text-left">
                        {header}
                      </th>
