  ...
  return (
    <nav className="px-5 pt-5 flex justify-between md:justify-around items-center relative shadow pb-4 bg-white font-bold text-black">
      ...
      <div className="hidden md:flex space-x-6">
        <Link className="hover:text-[#A31621] hover:underline" to="/">
          Home
        </Link>
        <Link className="hover:text-[#A31621] hover:underline" to="/services">
          Services
        </Link>
        <Link className="hover:text-[#A31621] hover:underline" to="/project">
          Project
        </Link>
      ...
      {open && (
        <div className="absolute top-full left-0 w-full bg-gray-400 md:hidden flex flex-col items-center py-5 space-y-4">
          <Link
            className="hover:text-[#A31621] hover:underline"
            to="/"
